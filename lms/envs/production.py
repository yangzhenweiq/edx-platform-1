...
# Payment
ALIPAY_INFO = AUTH_TOKENS.get('ALIPAY_INFO')
ALIPAY_APP_INFO = AUTH_TOKENS.get('ALIPAY_APP_INFO')
WECHAT_PAY_INFO = AUTH_TOKENS.get('WECHAT_PAY_INFO')
...
#for SMS
SMS_API = AUTH_TOKENS['SMS_API']
SMS_API_BY_LINKGROUP = AUTH_TOKENS['SMS_API_BY_LINKGROUP']
