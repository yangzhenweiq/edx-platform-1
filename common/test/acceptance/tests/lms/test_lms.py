...
@attr(shard=19)
class RegisterForCourse(EventsTestMixin, UniqueCourseTest):
    ...
    def setUp(self):
        ...
        Create the necessary page objects, create course page and courses to fin.
        """
        # create index file
        ...
        super(RegisterForCourse, self).setUp()
